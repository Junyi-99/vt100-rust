...
impl Row {
    ...
    pub fn erase(&mut self, i: u16, attrs: crate::attrs::Attrs) {
        ...
        // `wide` is read pre-erase: a 2-wide char's last column is cols() - 2.
        // saturating_sub avoids underflow for an orphaned wide cell in a
        // one-column row.
...
mod tests {
    ...
    // An orphaned wide cell (wide flag set, no continuation) in a one-column
    // row must not make Row::erase underflow deriving the last column as
    // cols() - 2.
    #[test]
